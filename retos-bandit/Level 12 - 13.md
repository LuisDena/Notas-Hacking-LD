...
## Solución
```bash
Pass siguiente lvl:wbWdlBxEir4CaE8LaPhauuOo6pwRmrDw

sol 1
bandit12@bandit:~$
bandit12@bandit:~$ ls data
...
bandit12@bandit:~$
bandit12@bandit:~$ echo "hola como estan como les va " | xxd
00000000: 686f 6c61 2063 6f6d 6f20 6573 7461 6e20  hola como estan
00000010: 636f 6d6f 206c 6573 2076 6120 0a         como les va .
bandit12@bandit:~$
bandit12@bandit:~$ cat data.txt | xxd -r
@4Aڀh4C@hd2@hF4XdBGaB~6VAGf͌>G`wBx)B׭xk|IFDs>R4"^d!P^g!)O^1IF    7<AVPIdJ-Se'yF7Y_1��Ft#^haX"l=]fwDZo,AB-e1
4@weRI7}8v9H;uH%}$iKL12v)|Rib AN]BA>Y|.Ebandit12@bandit:~$
bandit12@bandit:~$ cat data.txt | xxd -r >datos
-bash: datos: Permission denied
bandit12@bandit:~$ cat data.txt | mkdir /tmp/dena |xxd -r > /tmp/dena/datos
-bash: /tmp/dena/datos: No such file or directory
bandit12@bandit:~$ cat data.txt | mkdir /tmp/dena/ |xxd -r > /tmp/dena/datos
mkdir: cannot create directory ‘/tmp/dena/’: File exists
bandit12@bandit:~$ mkdir /tmp/dena
mkdir: cannot create directory ‘/tmp/dena’: File exists
bandit12@bandit:~$ cat data.txt | xxd -r > /tmp/dena/datos
bandit12@bandit:~$ cd tmp/dena
-bash: cd: tmp/dena: No such file or directory
bandit12@bandit:~$ cd tmp/dena/
-bash: cd: tmp/dena/: No such file or directory
bandit12@bandit:~$ cd /tmp/dena/
bandit12@bandit:/tmp/dena$ ls
datos
bandit12@bandit:/tmp/dena$ datos
Command 'datos' not found, did you mean:
  command 'dat2s' from deb liballegro4-dev (2:4.4.3.1-2)
Try: apt install <deb name>
bandit12@bandit:/tmp/dena$ cat datos
@4Aڀh4C@hd2@hF4XdBGaB~6VAGf͌>G`wBx)B׭xk|IFDs>R4"^d!P^g!)O^1IF    7<AVPIdJ-Se'yF7Y_1��Ft#^haX"l=]fwDZo,AB-e1
4@weRI7}8v9H;uH%}$iKL12v)|Rib AN]BA>Y|.Ebandit12@bandit:/tmp/dena$
bandit12@bandit:/tmp/dena$ mv datos datos.gz
bandit12@bandit:/tmp/dena$ ls
datos.gz
bandit12@bandit:/tmp/dena$ gzip -d datos.gz
bandit12@bandit:/tmp/dena$ file datos
datos: bzip2 compressed data, block size = 900k
bandit12@bandit:/tmp/dena$ mv datos datos.bz2
bandit12@bandit:/tmp/dena$ bzip2 -d datos.bz2
bandit12@bandit:/tmp/dena$ file datos
...
bandit12@bandit:/tmp/dena$ mv datos datos.tar
bandit12@bandit:/tmp/dena$ tar xf datos.tar
bandit12@bandit:/tmp/dena$ ls
data5.bin  datos.tar
bandit12@bandit:/tmp/dena$ rm datos.tar
bandit12@bandit:/tmp/dena$ ls
data5.bin
bandit12@bandit:/tmp/dena$ file data5.bin
data5.bin: POSIX tar archive (GNU)
bandit12@bandit:/tmp/dena$ mv data5.bin data5.tar
bandit12@bandit:/tmp/dena$ ls
data5.tar
bandit12@bandit:/tmp/dena$ tar xf data5.tar
bandit12@bandit:/tmp/dena$ ls
data5.tar  data6.bin
bandit12@bandit:/tmp/dena$ rm data
data5.tar  data6.bin
bandit12@bandit:/tmp/dena$ rm data5.tar
bandit12@bandit:/tmp/dena$ ls
data6.bin
bandit12@bandit:/tmp/dena$ file data6.bin
data6.bin: bzip2 compressed data, block size = 900k
bandit12@bandit:/tmp/dena$ mv data6.bin data6.bz2
bandit12@bandit:/tmp/dena$ bzip2 -d data6.bz2
bandit12@bandit:/tmp/dena$ ls
data6
bandit12@bandit:/tmp/dena$ file data6
data6: POSIX tar archive (GNU)
bandit12@bandit:/tmp/dena$ mv data6 data6.tar
bandit12@bandit:/tmp/dena$ tar xf data6.tar
bandit12@bandit:/tmp/dena$ ls
data6.tar  data8.bin
bandit12@bandit:/tmp/dena$ rm data6.tar
bandit12@bandit:/tmp/dena$ file data8.bin
data8.bin: gzip compressed data, was "data9.bin", last modified: Sun Apr 23 18:04:23 2023, max compression, from Unix, original size modulo 2^32 49
bandit12@bandit:/tmp/dena$ mv data8.bin data8.gz
bandit12@bandit:/tmp/dena$ gzip -d data8.gz
bandit12@bandit:/tmp/dena$ cat data8
The password is wbWdlBxEir4CaE8LaPhauuOo6pwRmrDw
bandit12@bandit:/tmp/dena$
...
/dev/stdin: POSIX tar archive (GNU)
bandit12@bandit:~$ xxd -r data.txt | zcat | bzcat | zcat | tar xO | tar xO | bzcat | tar xO |f
ile -
...
-bash: syntax error near unexpected token `|'
bandit12@bandit:~$ xxd -r data.txt | zcat | bzcat | zcat | tar xO | tar xO | bzcat | tar xO | | bzcat | file -
-bash: syntax error near unexpected token `|'
bandit12@bandit:~$ xxd -r data.txt | zcat | bzcat | zcat | tar xO | tar xO | bzcat | tar xO | | bzcat
-bash: syntax error near unexpected token `|'
bandit12@bandit:~$ xxd -r data.txt | zcat | bzcat | zcat | tar xO | tar xO | bzcat | tar xO | | zcat
-bash: syntax error near unexpected token `|'
...
| Comando  | Descripción | 
|------------|--------------|
|hexdump | vaciado hexadecimal|
| xxd| hacer vaciado hexadecimal |
| -r | reversing|
|tar xf |descomprimir |
|ext=.gz,comp=gzip, desc -d  |compresion en linux |
|ext=.bz2,comp=bzip, desc -d  |compresion en linux |
