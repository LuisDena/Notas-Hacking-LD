...
## Pistas
P1:There are tools that make this easy.
P2:Perhaps looking at history will help
...
## Solución
```bash
Pass siguiente lvl: picoCTF{b311a50_0r_v1gn3r3_c1ph3ra966878a} 
----------------------------------------------
┌──(kali㉿kali)-[~/Downloads]
...
y lo llevamos a la pagina lo que nos da
