...
## Pistas
P1: Download the certificate signing request and try to read it.
...
## Solución
```bash
Pass siguiente lvl: picoCTF{read_mycert_693f7c03}
--------------------------------------------------------------------------------------
usamos una pagina web como cyberchef u otras 
--------------------------------------------------------------------------------------
                                                                                                                     
┌──(kali㉿kali)-[~/Downloads/crypto-3/5]
└─$ ls -la
total 12
drwxr-xr-x 2 kali kali 4096 Nov  1 13:12 .
drwxr-xr-x 8 kali kali 4096 Nov  1 13:11 ..
-rw-r--r-- 1 kali kali  997 Mar 15  2023 readmycert.csr
...
┌──(kali㉿kali)-[~/Downloads/crypto-3/5]
└─$ openssl x509 -text -noout -in readmycert.csr 
Could not read certificate from readmycert.csr
Unable to load certificate
                                                                                                                     
┌──(kali㉿kali)-[~/Downloads/crypto-3/5]
└─$ openssl rec -text -noout -in readmycert.csr
Invalid command 'rec'; type "help" for a list.
...
## Referencias 
https://gchq.github.io/CyberChef/#recipe=From_Base64('A-Za-z0-9%2B/%3D',true,false)&input=